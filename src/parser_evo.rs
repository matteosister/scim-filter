...
use nom::bytes::complete::{
    is_a, is_not, tag, tag_no_case, take, take_till, take_until, take_while,
};
use nom::character::complete::{
    alpha1, alphanumeric1, anychar, char, digit0, digit1, hex_digit1, space0, space1,
};
...
use crate::parser_evo::Filter::{LogExp, ValuePath};
use crate::parser_evo::ValFilter::AttrExp;
...
struct LogExpData<'a> {
    left: Box<Filter<'a>>,
    log_exp_operator: LogExpOperator,
    right: Box<Filter<'a>>,
}
